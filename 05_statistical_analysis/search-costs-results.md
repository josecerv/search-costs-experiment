...
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{6}{l}{\parbox{\linewidth}{\vspace{2pt}Clustered standard errors at department level in parentheses.\\$^{+}p<0.1$; $^{*}p<0.05$; $^{**}p<0.01$; $^{***}p<0.001$\vspace{2pt}}} \\ 
\end{tabular} 
\end{adjustbox}
\end{table}
...
\begin{tabular}{@{\extracolsep{2pt}}l*{6}{c}}
\toprule
 & \multicolumn{2}{c}{\% Count} & \multicolumn{2}{c}{Count Count} & \multicolumn{2}{c}{Any Count} \\
 & (1) & (2) & (3) & (4) & (5) & (6) \\
\midrule
\hline \\[-1.8ex] 
...
\begin{tabular}{lcccc}
\toprule
 & \multicolumn{2}{c}{Simple Model} & \multicolumn{2}{c}{Extended Model} \\
Outcome & Coefficient & SE & Coefficient & SE \\
\midrule
URM Speakers & 0.0928 & (0.0692) & 0.0699 & (0.0677) \\
Non-URM Speakers & -0.5352 & (0.5232) & -0.5561 & (0.5111) \\
\midrule
Sum of Effects & -0.4424 & --- & -0.4861 & --- \\
\midrule
\multicolumn{5}{l}{\textit{Note: SUR estimation failed; showing OLS estimates with clustered SEs}} \\
\multicolumn{5}{l}{\textit{Sum close to zero: Model 1 = -0.4424, Model 2 = -0.4861}} \\
\bottomrule
\end{tabular}
\parbox{\linewidth}{\footnotesize Note: SUR estimation failed due to computational issues (likely multicollinearity). Table shows OLS estimates with clustered standard errors. The sum of effects being close to zero suggests a substitution pattern even without formal SUR testing.}
\end{table}
...
\begin{tabular}{@{\extracolsep{2pt}}l*{6}{c}}
\toprule
 & \multicolumn{2}{c}{\% Black} & \multicolumn{2}{c}{Count Black} & \multicolumn{2}{c}{Any Black} \\
 & (1) & (2) & (3) & (4) & (5) & (6) \\
\midrule
\hline \\[-1.8ex] 
...
\begin{tabular}{@{\extracolsep{2pt}}l*{6}{c}}
\toprule
 & \multicolumn{2}{c}{\% Hispanic} & \multicolumn{2}{c}{Count Hispanic} & \multicolumn{2}{c}{Any Hispanic} \\
 & (1) & (2) & (3) & (4) & (5) & (6) \\
\midrule
\hline \\[-1.8ex] 
...
\begin{tabular}{@{\extracolsep{2pt}}l*{6}{c}}
\toprule
 & \multicolumn{2}{c}{\% Female} & \multicolumn{2}{c}{Count Female} & \multicolumn{2}{c}{Any Female} \\
 & (1) & (2) & (3) & (4) & (5) & (6) \\
\midrule
\hline \\[-1.8ex] 
...
\begin{tabular}{@{\extracolsep{2pt}}l*{6}{c}}
\toprule
 & \multicolumn{2}{c}{\% URM Female} & \multicolumn{2}{c}{Count URM Female} & \multicolumn{2}{c}{Any URM Female} \\
 & (1) & (2) & (3) & (4) & (5) & (6) \\
\midrule
\hline \\[-1.8ex] 
...
\begin{tabular}{@{\extracolsep{2pt}}l*{6}{c}}
\toprule
 & \multicolumn{2}{c}{\% Black Female} & \multicolumn{2}{c}{Count Black Female} & \multicolumn{2}{c}{Any Black Female} \\
 & (1) & (2) & (3) & (4) & (5) & (6) \\
\midrule
\hline \\[-1.8ex] 
...
\begin{tabular}{@{\extracolsep{2pt}}l*{6}{c}}
\toprule
 & \multicolumn{2}{c}{\% Black Male} & \multicolumn{2}{c}{Count Black Male} & \multicolumn{2}{c}{Any Black Male} \\
 & (1) & (2) & (3) & (4) & (5) & (6) \\
\midrule
\hline \\[-1.8ex] 
...
\begin{tabular}{@{\extracolsep{2pt}}l*{6}{c}}
\toprule
 & \multicolumn{2}{c}{\% Hispanic Female} & \multicolumn{2}{c}{Count Hispanic Female} & \multicolumn{2}{c}{Any Hispanic Female} \\
 & (1) & (2) & (3) & (4) & (5) & (6) \\
\midrule
\hline \\[-1.8ex] 
...
\begin{tabular}{@{\extracolsep{2pt}}l*{6}{c}}
\toprule
 & \multicolumn{2}{c}{\% Hispanic Male} & \multicolumn{2}{c}{Count Hispanic Male} & \multicolumn{2}{c}{Any Hispanic Male} \\
 & (1) & (2) & (3) & (4) & (5) & (6) \\
\midrule
\hline \\[-1.8ex] 
...
\begin{table}[H]
\caption{Fall Semester: Effect on URM Speakers}
\label{tab:fall_urm}
\centering
\scriptsize
\begin{adjustbox}{max width=\textwidth}
...
\end{table}
\begin{table}[H]
\caption{Fall Semester: Effect on Black Speakers}
...
\end{table}
\begin{table}[H]
\caption{Fall Semester: Effect on Hispanic Speakers}
...
\begin{table}[H]
\caption{Spring Semester: Effect on URM Speakers}
...
\end{table}
\begin{table}[H]
\caption{Spring Semester: Effect on Black Speakers}
...
\end{table}
\begin{table}[H]
\caption{Spring Semester: Effect on Hispanic Speakers}
...
\begin{table}[H]
\caption{Moderation by Department Ranking}
...
\begin{table}[H]
\caption{Moderation by Department Faculty Size}
...
\begin{table}[H]
\caption{Moderation by URM Faculty in Peer Departments}
...
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{3.5cm} p{2.5cm} p{2.5cm} l r r r r l}
\toprule
Analysis & Outcome & Variable & Model & Coef. & SE & t-stat & p-value & Sig. \\
\midrule
\multicolumn{9}{l}{\textbf{ Demographic Analysis }} \\
\midrule
...
\midrule
Discipline: Computer Science & \% URM & Treatment & Simple & 2.2852 & 1.3775 & 1.659 & 0.0996 & + \\
Discipline: Computer Science & Any Hispanic & Treatment & Extended & 0.1563 & 0.0832 & 1.880 & 0.0626 & + \\
Discipline: Mathematics & \% URM & Treatment & Extended & 1.4949 & 0.8357 & 1.789 & 0.0740 & + \\
Discipline: Mathematics & Count Black & Treatment & Extended & 0.0998 & 0.0578 & 1.726 & 0.0848 & + \\
Discipline: Mechanical Engineering & \% Black & Treatment & Simple & 2.7713 & 1.0807 & 2.564 & 0.0127 & * \\
Discipline: Mechanical Engineering & Any Black & Treatment & Extended & 0.2857 & 0.0972 & 2.940 & 0.0047 & ** \\
Discipline: Mechanical Engineering & Count Black & Treatment & Simple & 0.5272 & 0.1654 & 3.187 & 0.0022 & ** \\
Discipline: Mechanical Engineering & Count URM & Treatment & Extended & 0.8092 & 0.3492 & 2.318 & 0.0241 & * \\
Discipline: Physics & \% Black & Treatment & Extended & 1.3330 & 0.6331 & 2.105 & 0.0360 & * \\
Discipline: Physics & Any Black & Treatment & Extended & 0.1337 & 0.0504 & 2.652 & 0.0084 & ** \\
Discipline: Physics & Count Black & Treatment & Extended & 0.1740 & 0.0679 & 2.562 & 0.0108 & * \\
Discipline: Physics & Count URM & Treatment & Extended & 0.2361 & 0.1406 & 1.680 & 0.0939 & + \\
\addlinespace[0.5em]
\multicolumn{9}{l}{\textbf{ Moderation Analysis }} \\
\midrule
Peer URM Moderation & \% URM & Peer URM Faculty (centered) & Extended & 0.1411 & 0.0560 & 2.517 & 0.0119 & * \\
Peer URM Moderation & Any URM & Peer URM Faculty (centered) & Simple & 0.0071 & 0.0024 & 2.987 & 0.0029 & ** \\
Peer URM Moderation & Count URM & Peer URM Faculty (centered) & Simple & 0.0177 & 0.0055 & 3.243 & 0.0012 & ** \\
Ranking Moderation & \% URM & Dept Ranking (centered) & Extended & 0.0265 & 0.0134 & 1.978 & 0.0481 & * \\
Ranking Moderation & Any URM & Dept Ranking (centered) & Simple & -0.0014 & 0.0006 & -2.527 & 0.0116 & * \\
Ranking Moderation & Count URM & Dept Ranking (centered) & Simple & -0.0034 & 0.0014 & -2.465 & 0.0138 & * \\
Ranking Moderation & Count URM & Treatment $\times$ Dept Ranking & Extended & 0.0039 & 0.0019 & 2.058 & 0.0397 & * \\
\addlinespace[0.5em]
...
\begin{table}[H]
\caption{Summary of Significant Results by Analysis Type (Excluding Constant Term)}
\label{tab:significant_summary}
\centering
\begin{tabular}{lcc}
\toprule
Analysis Type & Total Significant & Significant at 5\% \\
\midrule
Demographic Subgroup & 6 & 2 \\
Discipline: Computer Science & 2 & 0 \\
Discipline: Mathematics & 2 & 0 \\
Discipline: Mechanical Engineering & 4 & 4 \\
Discipline: Physics & 4 & 3 \\
Fall Semester & 4 & 3 \\
Peer URM Moderation & 3 & 3 \\
Ranking Moderation & 4 & 4 \\
\midrule
Total & 29 & 19 \\
\bottomrule
\end{tabular}
